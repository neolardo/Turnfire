...
{
    public readonly int TotalDamageDealtToEnemies;
    public readonly int TotalDamageDealtToAllies;
    ...
    public static ItemBehaviorSimulationResult Healing(int healing) => new ItemBehaviorSimulationResult(Vector2.zero, 0, 0, healing, 0, 0);
    public static ItemBehaviorSimulationResult Damage(Vector2 center, int enemyDamage, int allyDamage) => new ItemBehaviorSimulationResult(center, enemyDamage, allyDamage, 0, 0, 0);
    
    public ItemBehaviorSimulationResult(Vector2 center, int enemyDamage, int allyDamage, int healing, int armorBoost, float mobilityBoost)
    {
        DamageCenter = center;
